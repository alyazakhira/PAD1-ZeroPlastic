...
@section('content')
    ...
    <section class="mt-3 mb-4">
        <h1 class="display-text fw-bold mb-2">Tambah Artikel</h1>
        <p class="h2-text mt-2">Percaya dirilah dengan kemampuanmu!</h2>
    </section>

    <!-- Form -->
    <section class="mt-2 mb-3">
        <form action="{{ route('m-article.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="date" class="form-control" id="diunggah_pada" name="diunggah_pada" placeholder="Tanggal Unggah">
            </div>
            <div class="mb-3">
