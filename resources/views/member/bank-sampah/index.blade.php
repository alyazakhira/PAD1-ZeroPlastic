...
@section('content')
    ...
    <section class="mt-3 mb-4">
        <div class="row align-items-center">
            ...
            <div class="col-lg-3">
                <a href="/m-bank/create" class="btn btn-success w-100 py-2 h2-text" type="button">+ Tambah</a>
            </div>
        </div>
    </section>
                ...
                <table class="table table-hover text-center">
                    ...
                    <tbody class="table-group-divider">
                        ...
                        <tr>
                            ...
                            <td>{{ $row->alamat }}</td>
                            <td>
                                <a type="button" class="btn btn-outline-success" href="{{ route('m-bank.edit', $row->id) }}">
                            ...
                            <td>
                                <form class="mx-1" action="{{ route('m-bank.destroy', $row->id) }}" method="POST">
                                    @csrf
