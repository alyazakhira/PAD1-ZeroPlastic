            ...
            <div class="container">
                <div id="slider-header" class="carousel slide" data-bs-ride="true">
                    ...
                    <div class="carousel-inner">
                        ...
                        <img src="asset-header/{{ $header1->gambar }}" class="d-block w-100" alt="header">
                        </div>
                        <div class="carousel-item">
                        <img src="asset-header/{{ $header2->gambar }}" class="d-block w-100" alt="infografis-1">
                        </div>
                        <div class="carousel-item">
                        <img src="asset-header/{{ $header3->gambar }}" class="d-block w-100" alt="infografis-2">
                        </div>
                    </div>
