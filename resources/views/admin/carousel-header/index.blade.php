            ...
            <div class="col-sm p-0 min-vh-100">
                ...
                <div class="container-fluid px-5 py-3">
                    ...
                    <section class="mt-3 mb-4">
                        <h1 class="display-text fw-bold mb-2">Header Halaman Depan</h1>
                        <p class="h2-text mt-2">Berikut ini merupakan gambar yang dipasang pada carousel halaman awal.</h2>
                    </section>
                    ...
                    <form action="{{ route('header.update') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="card">
                                    ...
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item">  
                                            <div>
                                                <img id="frame1" src="{{ asset('asset-header/'. $header1->gambar) }}" class="img-fluid" />
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="card">
                                    ...
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item">  
                                            <div>
                                                <img id="frame2" src="{{ asset('asset-header/'. $header2->gambar) }}" class="img-fluid" />
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                                    ...
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item">  
                                            <div class="justify-content-center align-items-center">
                                                <img id="frame3" src="{{ asset('asset-header/'. $header3->gambar) }}" class="img-fluid" />
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <div class="row">
                            <div class="d-grid gap-2 mx-auto">
                                <button class="btn btn-success btn-lg" type="submit">Unggah</button>
                            </div>
                        </div>
                    </form>
                    </section>
