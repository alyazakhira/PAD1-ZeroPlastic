...
@section('content')
    ...
    <section class="mt-3 mb-4">
        <h1 class="display-text fw-bold mb-2">Ubah Email</h1>
        <p class="h2-text mt-2">Jangan lupa untuk mengecek lagi sebelum kirim!</h2>
    </section>

    <!-- Form -->
    <section class="mt-2 mb-3">
        <form action="{{ route('subscriber.update', $subs->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
                <label for="email" class="form-label fw-semibold">Email</label>
                <input type="email" class="form-control" id="email" name="email" placeholder="Email" value="{{ $subs->email }}">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="tahun" name="tahun" placeholder="0000" value="{{ $tahun }}">
            </div>
