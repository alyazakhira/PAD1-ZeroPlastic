...
@section('content')
    ...
    <section class="mt-3 mb-4">
        ...
        <p class="h2-text mt-2">Jangan lupa periksa lagi sebelum mengirim!</h2>
    </section>
    ...
    <section class="mt-2 mb-3">
        <form action="{{ route('product.update', $produk->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="date" class="form-control" id="diunggah_pada" name="diunggah_pada" value="{{ $produk->diunggah_pada }}">
            </div>
            <div class="mb-3">
