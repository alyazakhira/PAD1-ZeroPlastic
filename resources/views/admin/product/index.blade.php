    ...
    <section class="mt-3 mb-4">
        <div class="row align-items-center">
            <div class="col-lg-9">
                ...
                <p class="h2-text mt-2">Berikut ini daftar produk yang telah diunggah.</h2>
            </div>
            <div class="col-lg-3">
                <a href="/product/create" class="btn btn-success w-100 py-2 h2-text" type="button">+ Tambah</a>
            </div>
        </div>
    </section>
